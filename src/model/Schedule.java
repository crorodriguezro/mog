...
public class Schedule {
    ...
    public Schedule(Schedule schedule) {
        ...
        for (int i = 0; i < tasks.length; i++) {
            ...
            tasks[i] = new Task(org.getId(), org.getRequiredSkills(),
                    org.getDuration(), org.getSuccessors(), org.getResourceId());
        }
  ...
  /*  public boolean[] getSuccesors() {
        ...
        int tempId;
        for (Task task : tasks) {
            for (int predecessor : task.getSuccessors()) {
...
//            }
     ...
     * the last of its successors gets finished.
     *
